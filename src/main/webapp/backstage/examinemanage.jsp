	...
	<table id="dg" class="easyui-datagrid" style="width: 100％">
		<thead>
			<tr style="text-align: center; margin: 0 auto">
				...
				<th field="realname" width="100" align="center">状态</th>
				<th field="gender" width="50" align="center">分数</th>
				<th field="idCard" width="200" align="center">资料类型</th>
				<th field="address" width="150" align="center">审核人</th>
